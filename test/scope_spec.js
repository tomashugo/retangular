...
describe('Scope', function () {
  ...
  describe('$digest', function () {
    ...
    it('allows destroying several $watches during diegst', function () {
      scope.aValue = 'abc';
      scope.counter = 0;
  ...
  describe('$watchGroup', function () {
    ...
    it('uses differente arrays for old and new values on subsequent runs', function () {
      var gotNewValues, gotOldValues;
    ...
    it('doest not call the zero-watch listener when deregistered first', function () {
      var counter = 0;
  ...
  describe('inheritance', function () {
    ...
    it('doest not cause a parent to inherit its properties', function () {
      var parent = new Scope();
    ...
    it('doest not digest its parent(s)', function () {
      var parent = new Scope();
      var child = parent.$new();
  ...
  describe('$watchCollection', function () {
    ...
    it('notices when an attribute is removed from and another is added to an object', function () {
      scope.counter = 0;
      scope.obj = { a: 1 };
...
describe('Events', function () {
  ...
  _.forEach(['$emit', '$broadcast'], function (method) {
    ...
    it('returns the event object on ' + method, function () {
      var returnedEvent = scope[method]('someEvent', 2);
    ...
    it('does not stop on exceptions on ' + method, function () {
      var listener1 = function (event) {
        throw 'listener 1 throwing an exception';
      };
      var listener2 = jasmine.createSpy();
      scope.$on('someEvent', listener1);
      scope.$on('someEvent', listener2);
